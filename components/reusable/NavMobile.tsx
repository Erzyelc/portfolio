...
const NavMobile = () => {
  ...
  return (
    <motion.div>
      <nav className='md:padding-layout flex h-[72px] items-center justify-between border-b border-white-800/50 bg-white-800 px-16 dark:border-gray-900/50 dark:bg-gray-800'>
        <Link href='/'>
